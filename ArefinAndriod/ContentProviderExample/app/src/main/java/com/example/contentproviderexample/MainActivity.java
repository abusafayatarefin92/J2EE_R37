...
public class MainActivity extends AppCompatActivity {
    ...
    public void deleteAllBirthdays(View view){
        String URL = "content://com.example.contentproviderexample.Birthday/friends";
    ...
    public void showAllBirthdays(View view){
        ...
        if(!c.moveToFirst()){
            ...
            do{
                result = result + "\n" + c.getString(c.getColumnIndex(BirthProvider.NAME)) + " with id " + c.getString(c.getColumnIndex(BirthProvider.ID)) + " has birthday: " + c.getString(c.getColumnIndex(BirthProvider.BIRTHDAY));
            }while (c.moveToNext());
