package com.arefin.beanlifecycle5;
...
public class MyAwareService implements ApplicationContextAware, ApplicationEventPublisherAware, BeanClassLoaderAware, BeanFactoryAware, BeanNameAware, EnvironmentAware, ImportAware, ResourceLoaderAware {
    ...
    public void setBeanClassLoader(ClassLoader classLoader) {
        ...
        System.out.println("setBeanClassLoader classloaer name: " + classLoader.getClass().getName());
    }

    @Override
    public void setBeanFactory(BeanFactory beanFactory) throws BeansException {
        System.out.println("setBeanFactory called");
        System.out.println("setBeanFactory employeebean singleton: " + beanFactory.isSingleton("emp1"));
    }

    @Override
    public void setBeanName(String s) {
        System.out.println("setBeanName called");
        System.out.println("setBeanName beanName defined in context: " + s);
    }
    ...
    public void setResourceLoader(ResourceLoader resourceLoader) {
        ...
        System.out.println("setResourceLoader Resource filename: " + resource.getFilename());
    }
     ...
     * is to get the array of bean definition names.
     ...
     * get the input stream for a file in the classpath.
     * ServletContextAware – to inject ServletContext object in MVC application, example usage is to read
     * context parameters and attributes.
     * ServletConfigAware – to inject ServletConfig object in MVC application, example usage is to get servlet
     * config parameters.
     */
}
